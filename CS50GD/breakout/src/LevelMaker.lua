...
function LevelMaker.createMap(level, locked_block)
    local bricks = {}

    -- randomly choose if there will be a locked block
    local random_val = math.random(1, 5)
